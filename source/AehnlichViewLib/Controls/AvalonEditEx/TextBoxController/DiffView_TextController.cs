    ...
    public partial class DiffView : TextEditor
    {
        ...
        private static readonly DependencyProperty TextBoxControllerProperty =
                                DependencyProperty.Register(
                                  ...
                                  typeof(DiffView),
                                  new FrameworkPropertyMetadata(null, DiffView.OnTextBoxControllerChanged));
        ...
        {
            element.SetValue(DiffView.TextBoxControllerProperty, value);
        }
        ...
        {
            return (ITextBoxController)element.GetValue(DiffView.TextBoxControllerProperty);
        }
        ...
        private static void OnTextBoxControllerChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (e.OldValue is ITextBoxController)
            {
                ...
                oldController.BeginChangeEvent -= DiffView.BeginChange;
                oldController.EndChangeEvent -= DiffView.EndChange;
                oldController.GetSelectedTextEvent -= DiffView.GetSelectedText;
            }
            ...
            if (e.NewValue is ITextBoxController)
            {
                ...
                if (elements.TryGetValue(newController, out test) == true)
                {
                    ...
                    newController.SelectAll -= DiffView.SelectAll;
                    newController.Select -= DiffView.Select;
                    newController.ScrollToLineEvent -= DiffView.ScrollToLine;
                    newController.CurrentSelectionEvent -= DiffView.CurrentSelection;
                    newController.BeginChangeEvent -= DiffView.BeginChange;
                    newController.EndChangeEvent -= DiffView.EndChange;
